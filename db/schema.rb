...
ActiveRecord::Schema.define(:version => 20120422033008) do
  ...
  create_table "onsite_lesson_locations", :force => true do |t|
    ...
    t.datetime "created_at",                :null => false
    t.datetime "updated_at",                :null => false
    t.integer  "onsite_course_location_id"
    t.date     "date"
  end

  add_index "onsite_lesson_locations", ["location_id"], :name => "index_onsite_lesson_locations_on_location_id"
  add_index "onsite_lesson_locations", ["onsite_course_location_id"], :name => "index_onsite_lesson_locations_on_onsite_course_location_id"
